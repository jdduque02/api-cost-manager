...
export class CategoryController {
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'Categoría creada.', type: CategoryResponseDto })
  @ApiBadRequestResponse({ description: 'Datos de entrada inválidos.', type: ErrorResponseDto })
  @ApiConflictResponse({ description: 'Ya existe una categoría con ese nombre.', type: ErrorResponseDto })
  @ApiInternalServerErrorResponse({ description: 'Error al crear la categoría.', type: ErrorResponseDto })
  async create(
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Listado de categorías.', type: [CategoryResponseDto] })
  async findAll(@CurrentUser() _currentUser: IntrospectResponse) {
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Categoría encontrada.', type: CategoryResponseDto })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Categoría actualizada.', type: CategoryResponseDto })
  @ApiNotFoundResponse({ description: 'Categoría no encontrada.', type: ErrorResponseDto })
  @ApiBadRequestResponse({ description: 'Datos de entrada inválidos.', type: ErrorResponseDto })
  async update(
    @Param('id', ParseIntPipe) id: number,
